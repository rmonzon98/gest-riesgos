...
function CambiarLogoBarra() {
    ...
    const refreshLogo = async () => {
        try {
            setLoading(true);
            const resp = await apiClient.get('/descargar/obtener-logo-barra');
    ...
    const submitDocument = async () => {
        ...
        try {
            setLoading(true);
            const resp = await apiClient.put('/descargar/update-image-logo-barra', formData, {
                headers: {
    ...
    return (
        <>
            <Card variant="outlined">
                <CardHeader title="Logo para Barra de navegación" />
...
export default CambiarLogoBarra;
